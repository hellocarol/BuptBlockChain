...
<html>
  ...
  <div class="container pt-100">
    ...
    <div class="row-fluid row">
		...
		<div>
			<form action="${pageContext.request.contextPath}/addaccount.action" method="post">
				<div class="input-group">
				<span class="input-group-addon" id="basic-addon1" >输入账户名</span> 
				<input
